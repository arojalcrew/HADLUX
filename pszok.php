...
<head>
    ...
    <title>HADLUX - Regulamin PSZOK</title>
</head>
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
      ...
      <a class="navbar-brand text_logo" href="index.php"><img id="logo" src="logo-1-300x140.png" alt=""><b>HADLUX <small>Sp. z o.o.</small></b></a>
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
              <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#"><i class="fa-solid fa-address-book"></i> &nbsp;<b>KONTAKT</b></a>
                </li>
                <li class="nav-item dropdown">
                  <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="#"><i class="fa-solid fa-book fa-shake"></i> &nbsp;<b>REGULAMIN PSZOK</b></a>
                </li>
              </ul>
      ...
      <header class="page-header gradient" id="back">
        <div class="container-fluid p-5 text-center byc_moze hidden">
            <div class="row align-items-center justify-content-center">
                <div class="col-md-12">
                    <h2><i class="fa-solid fa-book fa-shake"></i>&nbsp;<b>REGULAMIN PSZOK</b></h2>
                    <img src="pszok1.jpg" alt="" class="img-fluid" id="pszok1">
                </div>
                <div class="col-md-12">
                    <img src="pszok2.jpg" alt="" class="img-fluid" id="pszok2">
                </div>
                <div class="col-md-12">
                    <img src="pszok3.jpg" alt="" class="img-fluid" id="pszok3">
                </div>
            </div>
        </div>
