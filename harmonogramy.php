...
<head>
    ...
    <title>HADLUX - Harmonogramy</title>
</head>
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
              ...
              <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    ...
                    <a class="dropdown-item active" href="#"><i class="fa-solid fa-calendar-days fa-bounce"></i>&nbsp;<b>HARMONOGRAMY</b></a>
      ...
      <header class="page-header gradient" id="back">  
        <div class="container-fluid pt-5">
            ...
            <h2 class="hidden"><i class="fa-solid fa-calendar-days fa-bounce"></i>&nbsp;<b>HARMONOGRAMY</b></h2>
            <section class="posts-grid">
            <div class="box-container">
            <?php
                $select_posts = $conn->prepare("SELECT * FROM `posty` WHERE status = ? AND category = 'Harmonogramy' ORDER BY id DESC LIMIT 6");
        ...
        <div style="margin-top: 2rem; text-align: center;">
            <a href="posts.php" class="btn btn-primary byc_moze hidden">Wyświetl wszystkie posty</a>
        </div>
