    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
              ...
              <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    ...
                    <a class="dropdown-item active" href="#"><i class="fa-solid fa-hand fa-bounce"></i>&nbsp;<b>PRZETARGI</b></a>
                </li>
                <li class="nav-item">
      ...
      <header class="page-header gradient" id="back">  
        <div class="container-fluid pt-5">
            ...
            <h2 class="hidden"><i class="fa-solid fa-hand fa-bounce"></i></i>&nbsp;<b>PRZETARGI</b></h2>
            <section class="posts-grid">
            <div class="box-container">
            <?php
                $select_posts = $conn->prepare("SELECT * FROM `posty` WHERE status = ? AND category = 'Przetargi' ORDER BY id DESC LIMIT 6");
