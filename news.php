...
<head>
    ...
    <title>HADLUX - Aktualności</title>
</head>
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
              <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <a class="dropdown-item active" href="#"><i class="fa-solid fa-signs-post fa-flip"></i>&nbsp;<b>NAJNOWSZE POSTY</b></a>
      ...
      <header class="page-header gradient" id="back">  
        <div class="container-fluid pt-5">
            ...
            <h2 class="hidden"><i class="fa-solid fa-signs-post fa-flip"></i>&nbsp;<b>NAJNOWSZE POSTY</b></h2>
            <section class="posts-grid">
            <div class="box-container">
            <?php
                $select_posts = $conn->prepare("SELECT * FROM `posty` WHERE status = ? ORDER BY id DESC LIMIT 6");
