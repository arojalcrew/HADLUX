    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
      ...
      <header class="page-header gradient" id="back">  
        <div class="container-fluid pt-5">
            ...
            <h2 class="hidden"><i class="fa-solid fa-magnifying-glass fa-spin fa-spin-reverse"></i>&nbsp;<b>ZNAJDŹ POST</b></h2>
            <?php
...
<section class="posts-grid">
   ...
   <div class="box-container">
      ...
      <?php
         ...
         $select_posts = $conn->prepare("SELECT * FROM `posty` WHERE title LIKE '%{$search_box}%' OR category LIKE '%{$search_box}%' or content LIKE '%{$search_box}%' AND status = ?");
      ...
      <?php
         ...
         echo '<div class="container p-5 hidden text-center"><div class="row align-items-center justify-content-center text-center"><div class="col-md-12"><p class="empty">Brak postów.</p></div></div></div>';
      }
      ?>
   </div>
...
<?php
      ...
      echo '<section><p class="empty">Znajdź</p></section>';
   }
?>
            </div>
          </div>
